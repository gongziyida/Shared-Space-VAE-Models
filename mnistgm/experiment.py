...
from mnistgm.networks.MNIST import EncMNIST, DecMNIST
from mnistgm.networks.GM import EncGM, DecGM

from utils.BaseExperiment import BaseExperiment


class MNISTGM(BaseExperiment):
    ...
    def set_model(self):
        model = VAEbimodalGMMNIST(self.flags, self.modalities, self.subsets)
    ...
    def get_transform_gm(self):
        transform_gm = transforms.Compose([transforms.ToTensor()])
        return transform_gm;
    ...
    def set_clfs(self):
        ...
        if self.flags.use_clf:
            ...
            # Todo: change it to a simple classifier as we know the means
            model_clf_m2 = ClfGM();
    ...
    def set_rec_weights(self):
        rec_weights = dict();
        ref_mod_d_size = self.modalities['gm'].data_size.numel();
    ...
    def set_style_weights(self):
        ...
        weights['gm'] = self.flags.beta_m2_style;
        return weights;
