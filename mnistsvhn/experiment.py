...
from mnistsvhn.networks.MNIST import EncMNIST, DecMNIST
from mnistsvhn.networks.SVHN import EncSVHN, DecSVHN

from utils.BaseExperiment import BaseExperiment


class MNISTSVHN(BaseExperiment):
    ...
    def set_model(self):
        model = VAEbimodalSVHNMNIST(self.flags, self.modalities, self.subsets)
